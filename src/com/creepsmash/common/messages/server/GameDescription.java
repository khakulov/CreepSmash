...
public class GameDescription {
	...
	public String toString() {
		...
		+ this.numberOfPlayers.toString() + " " + this.currentPlayers
		+ " " + this.getMaxEloPoints() + " " + this.getMinEloPoints() + " "
		+ "" + this.getGameMod() + " "
		+ "\"" +Message.prepareToSend(this.getPasswort()) + "\" "
		+ "\"" +Message.prepareToSend(this.getPlayer1()) + "\" "
		+ "\"" +Message.prepareToSend(this.getPlayer2()) + "\" "
		+ "\"" +Message.prepareToSend(this.getPlayer3()) + "\" "
		+ "\"" +Message.prepareToSend(this.getPlayer4()) + "\" "
		+ "\"" + this.state + "\"";
	}
